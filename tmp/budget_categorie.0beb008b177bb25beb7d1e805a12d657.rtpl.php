<?php if(!class_exists('raintpl')){exit;}?><div id="widget_budget_categorie">
			...
			<li>
				...
				<div class="budget">
					<div  class="budget_categorie">
						<?php echo $value1["budget"];?> &euro;
					</div>
					<div class="depense">
						<?php echo $value1["budget_utilise"];?> &euro;
					</div>
					<div class="restant">
						<?php echo $value1["budget_restant"];?> &euro;
					</div>
				</div>
			</li>
			<?php } ?>
